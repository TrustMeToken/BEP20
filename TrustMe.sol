...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "TRUSTME";
    string internal constant SYMBOL = "TRUSTME";
    ...
    uint256 internal constant TOTAL_SUPPLY = 3 * 10 ** 7 * ZEROES;
     ...
     */
    address internal tipToTheDev = 0x25542C1992351956855074051725275a20761224;
